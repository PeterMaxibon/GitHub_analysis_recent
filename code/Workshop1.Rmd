...
nrow and ncol in the code specifies the number of rows and columns for the data to be displayed in. some other arguments like scales, shrink are used to control the layout of the individual panel.  
```{r}
ggplot(data = mpg) +
  geom_point(mapping = aes(x = displ, y = hwy)) +
  facet_wrap( = TRUE)
